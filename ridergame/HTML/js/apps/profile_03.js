...
$('#continue_02A').click(function () {
    ...
    // MODAL TXT
    $('#hourB').text('10 ore');$('#moneyB').text('75 euro');
...
$('#continue_02B').click(function () {
    ...
    // MODAL TXT
    $('#hourB').text('5 ore');$('#moneyB').text('50 euro');
    $('#form_01').delay(500).fadeIn(1000);
...
$('#continue_02C').click(function () {
    ...
    // MODAL TXT
    $('#hourB').text('7 ore');$('#moneyB').text('61 euro');
    $('#form_01').delay(500).fadeIn(1000);
...
$('#continue_07').click(function () {
    ...
    $('#hourB').text('20 ore');$('#moneyB').text('150 euro');
    // MONEY SET HERE
    var AA = +(document.getElementById("money").innerText);
    var B = 150;
    var CA = +AA + +B; 
...
$('#divergency_2').click(function () {
    ...
    $('.background').removeClass('main_bg03');
    randomBG();
    $('#hourB').text('36 ore');$('#moneyB').text('253 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 253;
    var C0 = +A0 + +B0;
...
$('#divergency_3').click(function () {
    ...
    $('#hourB').text('40 ore');$('#moneyB').text('185 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 185;
    var C0 = +A0 + +B0;
...
$('#divergency_4').click(function () {
    ...
    $('#hourB').text('31 ore');$('#moneyB').text('260 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 260;
    var C0 = +A0 + +B0;
...
$('#opA').click(function () {
    ...
    $('#hourB').text('12 ore');$('#moneyB').text('106 euro');
});
...
$('#opB').click(function(){
    ...
    randomST2();resetAnimation();
    $('.after_motion_p6').fadeOut(1);
    $('#hourB').text('7 ore');$('#moneyB').text('53 euro');
});
...
$('#opC').click(function(){
    ...
    randomST2();resetAnimation();
    $('.after_motion_p6').fadeOut(1);
    $('#hourB').text('7 ore');$('#moneyB').text('66 euro');
});
...
$('#opA_N').click(function(){
    ...
    $('#hourB').text('40 ore');$('#moneyB').text('205 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 205;
    var C0 = +A0 + +B0;
...
$('#opB_N').click(function(){
    ...
    randomBG();
    $('#popup .modal-content').removeClass('imprevisto imprevisto-green');
    $('#hourB').text('35 ore');$('#moneyB').text('206 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 206;
    var C0 = +A0 + +B0;
...
$('#opC_N').click(function(){
    $('#working').fadeOut(100);transitionM();resetAnimation();arcade_5.pause();arcadeFc_4();
    $('#popup .modal-content').removeClass('imprevisto imprevisto-green');
    $('#hourB').text('25 ore');$('#moneyB').text('191 euro');
    randomBG();
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 191;

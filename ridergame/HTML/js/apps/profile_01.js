...
$('#continue_01').click(function () {
    ...
    $('#continue_02, p.after_motion_p4, #working').fadeIn(1000);
    $('.background').removeClass('main_bg02');
    $('.background').addClass('main_bg03');
    WTF();
});    
$('#continue_02').click(function () {
    $('#working').fadeOut(100);
    $('#continue_02, p.after_motion_p4').fadeOut(1);
    $('#continue_03, p.after_motion_p5').fadeIn(1000);
    $('.background').removeClass('main_bg03');
    randomBG();
    // MODAL TXT
    $('#hourB').text('10 ore');$('#moneyB').text('72 euro');
...
$('#continue_03').click(function () {
    ...
    if ( $("#clearOptions_3").is(':checked') || $("#clearOptions_2").is(':checked') || $("#clearOptions_1").is(':checked') ){
        ...
        $('.after_motion_p6, .p3_buttons.setbtn1').delay(3000).fadeIn(1000);
...
$('#continue_07').click(function () {
    resetAnimation();
    $('#working').fadeOut(100);
    $('p.after_motion_p9.target').hide();
    modal.style.display = 'block';
    $('#hourB').text('35 ore');$('#moneyB').text('279 euro');
    // MONEY SET HERE
    var AA = +(document.getElementById("money").innerText);
    var B = 279;
    var CA = +AA + +B; 
...
$('#continue_08').click(function () {
    ...
    removeRDback();
    $('.background').addClass('main_bg04');
    $('#hourB').text('25 ore');$('#moneyB').text('196 euro');
    // MONEY SET HERE
    var AA = +(document.getElementById("money").innerText);
    var B = 196;
    var CA = +AA + +B; 
...
$('#divergency_2').click(function () {
    ...
    $('.background').removeClass('main_bg03');
    randomBG();
    $('#hourB').text('53 ore');$('#moneyB').text('370 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 370;
    var C0 = +A0 + +B0;
...
$('#divergency_3').click(function () {
    ...
    $('#hourB').text('48 ore');$('#moneyB').text('211 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 211;
    var C0 = +A0 + +B0;
...
$('#divergency_4').click(function () {
    ...
    $('#hourB').text('37 ore');$('#moneyB').text('288 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 288;
    var C0 = +A0 + +B0;
...
$('#opA').click(function () {
    ...
    $('#hourB').text('11 ore');$('#moneyB').text('83 euro');
});
...
$('#opB').click(function(){
    ...
    randomST2();resetAnimation();
    $('.after_motion_p6').fadeOut(1);
    $('#hourB').text('7 ore');$('#moneyB').text('63 euro');
});
...
$('#opC').click(function(){
    ...
    randomST2();resetAnimation();
    $('.after_motion_p6').fadeOut(1);
    $('#hourB').text('18 ore');$('#moneyB').text('146 euro');
});
...
$('#opA_N').click(function(){
    $('#working').fadeOut(100);transitionM();
    resetAnimation();arcade_5.pause();arcadeFc_4();
    randomBG();
    $('#popup .modal-content').removeClass('imprevisto imprevisto-green');
    
    $('#hourB').text('45 ore');$('#moneyB').text('304 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 304;
    var C0 = +A0 + +B0;
...
$('#opB_N').click(function(){
    ...
    randomBG();
    $('#popup .modal-content').removeClass('imprevisto imprevisto-green');
    $('#hourB').text('40 ore');$('#moneyB').text('187 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 187;
    var C0 = +A0 + +B0;
...
$('#opC_N').click(function(){
    ...
    resetAnimation();arcade_5.pause();arcadeFc_4();
    $('#popup .modal-content').removeClass('imprevisto imprevisto-green');
    $('#hourB').text('32 ore');$('#moneyB').text('231 euro');
    randomBG();
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 231;
...
$('#opD_N').click(function(){
    ...
    $('p.newApp_p4').delay(2500).fadeIn(1500);
    $('#continue_11').delay(3500).fadeIn(1500);
    $('.background').removeClass('main_bg04');
    randomBG();
});   
}    
...
$('#continue_02A').click(function () {
    ...
    // MODAL TXT
    $('#hourB').text('12 ore');$('#moneyB').text('92 euro');
...
$('#continue_02B').click(function () {
    ...
    // MODAL TXT
    $('#hourB').text('7 ore');$('#moneyB').text('60 euro');
    $('#form_01').delay(500).fadeIn(1000);
...
$('#continue_02C').click(function () {
    ...
    // MODAL TXT
    $('#hourB').text('9 ore');$('#moneyB').text('70 euro');
    $('#form_01').delay(500).fadeIn(1000);
    $('.background').removeClass('main_bg03');
    randomBG();
...
$('#continue_07').click(function () {
    ...
    $('#hourB').text('22 ore');$('#moneyB').text('171 euro');
    // MONEY SET HERE
    var AA = +(document.getElementById("money").innerText);
    var B = 171;
    var CA = +AA + +B; 
...
$('#continue_08').click(function () {
    resetAnimation();
    modal.style.display = 'block';
    $('#hourB').text('10 ore');$('#moneyB').text('80 euro');
    removeRDback();
...
$('#divergency_2').click(function () {
    ...
    $('.background').removeClass('main_bg03');
    randomBG();
    $('#hourB').text('37 ore');$('#moneyB').text('227 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 227;
    var C0 = +A0 + +B0;
...
$('#divergency_3').click(function () {
    ...
    $('#hourB').text('41 ore');$('#moneyB').text('245 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 245;
    var C0 = +A0 + +B0;
...
$('#divergency_4').click(function () {
    ...
    $('#hourB').text('34 ore');$('#moneyB').text('270 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 270;
    var C0 = +A0 + +B0;
...
$('#opA').click(function () {
    ...
    $('#hourB').text('15 ore');$('#moneyB').text('121 euro');
});
...
$('#opB').click(function(){
    ...
    randomST2();resetAnimation();
    $('.after_motion_p6').fadeOut(1);
    $('#hourB').text('8 ore');$('#moneyB').text('73 euro');
});
...
$('#opC').click(function(){
    ...
    randomST2();resetAnimation();
    $('.after_motion_p6').fadeOut(1);
    $('#hourB').text('10 ore');$('#moneyB').text('82 euro');
});
...
$('#opA_N').click(function(){
    ...
    $('#hourB').text('42 ore');$('#moneyB').text('273 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 273;
    var C0 = +A0 + +B0;
...
$('#opB_N').click(function(){
    ...
    randomBG();
    $('#popup .modal-content').removeClass('imprevisto imprevisto-green');
    $('#hourB').text('37 ore');$('#moneyB').text('210 euro');
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 210;
    var C0 = +A0 + +B0;
...
$('#opC_N').click(function(){
    ...
    $('#popup .modal-content').removeClass('imprevisto imprevisto-green');
    $('#hourB').text('28 ore');$('#moneyB').text('220 euro');
    randomBG();
    modal.style.display = 'block';
    var A0 = +(document.getElementById("money").innerText);
    var B0 = 220;
